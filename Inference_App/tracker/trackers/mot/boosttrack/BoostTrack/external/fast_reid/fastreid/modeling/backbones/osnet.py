...
class OSBlock(nn.Module):
    ...
    def __init__(
        self, in_channels, out_channels, bn_norm, IN=False, bottleneck_reduction=4, **kwargs
    ):
...
class OSNet(nn.Module):
    ...
    def __init__(self, blocks, layers, channels, bn_norm, IN=False, **kwargs):
        ...
        self.conv3 = self._make_layer(
            blocks[1], layers[1], channels[1], channels[2], bn_norm, reduce_spatial_size=True
        )
    ...
    def _make_layer(
        self, block, layer, in_channels, out_channels, bn_norm, reduce_spatial_size, IN=False
    ):
        layers = []
