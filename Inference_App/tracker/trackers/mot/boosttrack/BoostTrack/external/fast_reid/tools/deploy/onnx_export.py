...
def get_parser():
    ...
    parser.add_argument(
        "--batch-size", default=1, type=int, help="the maximum batch size of onnx runtime"
    )
    parser.add_argument(
        "--opts",
...
if __name__ == "__main__":
    ...
    inputs = torch.randn(args.batch_size, 3, cfg.INPUT.SIZE_TEST[0], cfg.INPUT.SIZE_TEST[1]).to(
        model.device
    )
