...
from fast_reid.fastreid.config import CfgNode, get_cfg
from fast_reid.fastreid.engine import DefaultTrainer, default_argument_parser, default_setup, hooks
...
def main(args):
    ...
    reporter = CLIReporter(
        parameter_columns=["bsz", "num_inst"], metric_columns=["r1", "map", "training_iteration"]
    )
