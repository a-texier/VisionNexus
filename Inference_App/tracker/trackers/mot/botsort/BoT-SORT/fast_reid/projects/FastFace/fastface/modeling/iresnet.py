...
class IResNet(nn.Module):
    ...
    def __init__(
        ...
        self.layer2 = self._make_layer(
            block, 128, layers[1], bn_norm, stride=2, dilate=replace_stride_with_dilation[0]
        )
        self.layer3 = self._make_layer(
            block, 256, layers[2], bn_norm, stride=2, dilate=replace_stride_with_dilation[1]
        )
        self.layer4 = self._make_layer(
            block, 512, layers[3], bn_norm, stride=2, dilate=replace_stride_with_dilation[2]
        )
