...
class QDTrack(TwoStageDetector):
    ...
    def _freeze_detector(self):
        ...
        self.detector = [self.backbone, self.neck, self.rpn_head, self.roi_head.bbox_head]
    ...
    def prepare_cfg(self, kwargs):
        if kwargs.get("train_cfg", False):
            kwargs["roi_head"]["track_train_cfg"] = kwargs["train_cfg"].get("embed", None)
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        bbox_result = bbox2result(det_bboxes, det_labels, self.roi_head.bbox_head.num_classes)
