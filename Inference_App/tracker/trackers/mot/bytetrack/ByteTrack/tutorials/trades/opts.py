...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "task", default="", help="ctdet | ddd | multi_pose | tracking or combined with ,"
        )
        self.parser.add_argument(
            "--dataset",
            default="coco",
        ...
        self.parser.add_argument(
            "--demo", default="", help='path to image/ image folders/ video. or "webcam"'
        )
        ...
        self.parser.add_argument(
            "--num_workers", type=int, default=4, help="dataloader threads. 0 for single-thread."
        )
        self.parser.add_argument(
            "--not_cuda_benchmark",
            action="store_true",
        ...
        # log
        self.parser.add_argument(
            "--print_iter", type=int, default=0, help="disable progress bar and print to screen."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--down_ratio", type=int, default=4, help="output stride. Currently only supports 4."
        )
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=1,
            help="number of images used in tradesincluding the current image",
        )
        ...
        self.parser.add_argument(
            "--input_h", type=int, default=-1, help="input height. -1 for default from dataset."
        )
        self.parser.add_argument(
            "--input_w", type=int, default=-1, help="input width. -1 for default from dataset."
        )
        ...
        self.parser.add_argument(
            "--master_batch_size", type=int, default=-1, help="batch size on the master gpu."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--not_max_crop",
            action="store_true",
            help="used when the training dataset hasinbalanced aspect ratios.",
        )
        self.parser.add_argument(
            "--shift",
            type=float,
            default=0,
            help="when not using random crop, 0.1apply shift augmentation.",
        )
        self.parser.add_argument(
            "--scale",
            type=float,
            default=0,
            help="when not using random crop, 0.4apply scale augmentation.",
        )
        self.parser.add_argument(
            "--aug_rot",
            type=float,
        ...
        self.parser.add_argument(
            ...
            type=float,
            default=0,
            help="when not using random cropapply rotation augmentation.",
        )
        self.parser.add_argument(
            "--flip", type=float, default=0.5, help="probability of applying flip augmentation."
        )
        self.parser.add_argument(
            "--no_color_aug",
            action="store_true",
        ...
        self.parser.add_argument(
            "--off_weight", type=float, default=1, help="loss weight for keypoint local offsets."
        )
        self.parser.add_argument(
            "--wh_weight", type=float, default=0.1, help="loss weight for bounding box size."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--amodel_offset_weight", type=float, default=1, help="Please forgive the typo."
        )
        self.parser.add_argument(
            "--dep_weight", type=float, default=1, help="loss weight for depth."
        )
        self.parser.add_argument(
            "--dim_weight", type=float, default=1, help="loss weight for 3d bounding box size."
        )
        self.parser.add_argument(
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        if "multi_pose" in opt.task:
            opt.heads.update(
                {"hps": dataset.num_joints * 2, "hm_hp": dataset.num_joints, "hp_offset": 2}
            )
    ...
    def init(self, args=""):
        ...
        train_dataset = (
            default_dataset_info[opt.task] if opt.task in default_dataset_info else "coco"
        )
        if opt.dataset != "coco":
