...
def main():
    ...
    parser.add_argument(
        "--script_prv", type=str, default=None, help="Name of the train script of previous model."
    )
    parser.add_argument(
        "--config_prv", type=str, default=None, help="Name of the config file of previous model."
    )
