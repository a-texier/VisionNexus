...
if __name__ == "__main__":
    ...
    trackers.extend(
        trackerlist("stark_mem", "baseline_roi_ep500", dataset_name, None, "baseline_roi_ep500")
    )

    trackers.extend(
        trackerlist(
            "vit_tracker", "cait_small_224_ep300", dataset_name, None, "cait_small_224_ep300"
        )
    )
    trackers.extend(
        trackerlist(
            "vit_tracker",
            "cait_small_224_fcos_new_32x4_ep300",
            dataset_name,
            None,
            "cait_small_224_fcos_new_32x4_ep300",
        )
    ...
    trackers.extend(
        trackerlist(
            "vit_tracker",
            "cait_small_224_fcos_cn_32x4_ep300_test_cn",
            dataset_name,
            None,
            "cait_small_224_fcos_cn_32x4_ep300_test_cn",
        )
