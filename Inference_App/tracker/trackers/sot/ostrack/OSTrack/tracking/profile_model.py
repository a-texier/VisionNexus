...
def parse_args():
    ...
    # for train
    parser.add_argument(
        "--script", type=str, default="ostrack", choices=["ostrack"], help="training script name"
    )
    parser.add_argument(
        "--config", type=str, default="vitb_256_mae_ce_32x4_ep300", help="yaml configure file name"
    )
