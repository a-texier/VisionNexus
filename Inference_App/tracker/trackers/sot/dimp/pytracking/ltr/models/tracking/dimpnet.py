...
class DiMPnet(nn.Module):
    ...
    def __init__(
        self, feature_extractor, classifier, bb_regressor, classification_layer, bb_regressor_layer
    ):
        super().__init__()
    ...
    def extract_features(self, im, layers=None):
        ...
        backbone_layers = sorted(
            list(set([l for l in layers + self.classification_layer if l != "classification"]))
        )
