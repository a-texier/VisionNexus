...
class LinearFilter(nn.Module):
    ...
    def __init__(
        ...
        self.filter_initializer = (
            filter_initializer  # Predicts an initial filter in a feed-forward manner
        )
        self.filter_optimizer = (
            filter_optimizer  # Iteratively updates the filter by minimizing the few-shot
        )
        # learning loss
