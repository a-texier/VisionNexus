...
class AVisTDataset(BaseDataset):
    ...
    def __init__(self, attribute=None):
        ...
        if attribute is not None:
            self.sequence_list = self._filter_sequence_list_by_attribute(
                attribute, self.sequence_list
            )
    ...
    def _construct_sequence(self, sequence_name):
        ...
        occlusion_label_path = "{}/full_occlusion/{}_full_occlusion.txt".format(
        ...
        out_of_view_label_path = "{}/out_of_view/{}_out_of_view.txt".format(
            self.base_path, sequence_name
        )
    ...
    def get_attribute_names(self, mode="short"):
        ...
        names = (
            self.att_dict["att_name_short"] if mode == "short" else self.att_dict["att_name_long"]
        )
        return names
