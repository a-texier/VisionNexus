...
dataset_dict = dict(
    ...
    trackingnetvos=DatasetInfo(
        module=pt % "trackingnet", class_name="TrackingNetDataset", kwargs=dict(vos_mode=True)
    ),
    ...
    lasot_train=DatasetInfo(
        module=pt % "lasot", class_name="LaSOTTrainSequencesDataset", kwargs=dict()
    ),
    lasot_extension_subset=DatasetInfo(
        module=pt % "lasotextensionsubset", class_name="LaSOTExtensionSubsetDataset", kwargs=dict()
    ),
    lasotvos=DatasetInfo(
        module=pt % "lasot", class_name="LaSOTDataset", kwargs=dict(vos_mode=True)
    ),
    oxuva_dev=DatasetInfo(module=pt % "oxuva", class_name="OxUvADataset", kwargs=dict(split="dev")),
    oxuva_test=DatasetInfo(
        module=pt % "oxuva", class_name="OxUvADataset", kwargs=dict(split="test")
    ),
    ...
    lagot_sot_mode=DatasetInfo(
        module=pt % "lagot", class_name="LaGOTDataset", kwargs=dict(sot_mode=True)
    ),
