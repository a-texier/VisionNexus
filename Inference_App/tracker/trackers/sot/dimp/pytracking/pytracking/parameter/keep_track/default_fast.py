...
def parameters():
    ...
    params.box_refinement_step_length = (
        2.5e-3  # 1   # Gradient step length in the bounding box refinement
    )
    ...
    params.target_candidate_matching_net = NetWrapper(
        net_path="keep_track.pth.tar", use_gpu=params.use_gpu
    )
