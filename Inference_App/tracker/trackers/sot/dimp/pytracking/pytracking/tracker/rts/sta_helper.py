...
class STAHelper:
    ...
    def predict_mask(self, image, bbox):
        ...
        im_patches, sample_coords, box_patches = self.extract_image_crops(
            all_images, all_boxes, self.img_sample_sz
        )
        ...
        segmentation_mask_im_test = segmentation_mask_im_test.view(
            *segmentation_mask_im_test.shape[-2:]
        )
