...
class ToMP(BaseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        translation_vec, scale_ind, s, flag, score_loc = self.localize_target(
    ...
    def visualize_raw_results(self, score_map):
        ...
        self.visdom.register(
            torch.tensor(self.logging_dict["max_score"]), "lineplot", 3, "Max Score"
        )
    ...
    def direct_bbox_regression(self, bbox_preds, sample_coords, score_loc, scores_raw):
        ...
        ltrb = (
            bbox_preds.permute(0, 1, 3, 4, 2)[0, 0].cpu() * self.train_img_sample_sz[[0, 1, 0, 1]]
        )
        xs1 = xs - ltrb[:, :, 0]
        xs2 = xs + ltrb[:, :, 2]
        ys1 = ys - ltrb[:, :, 1]
