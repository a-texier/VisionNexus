...
def main():
    parser = argparse.ArgumentParser(description="Launch mlflow-app")
    ...
    env = {**os.environ,
           "MLFLOW_APP_WORKSPACE": ws, "MLFLOW_APP_USER": args.user, "MLFLOW_APP_FRONTEND_PORT": str(fp),
    ...
    print("=" * 60); print(f"  mlflow-app — {args.user}"); print("=" * 60)
