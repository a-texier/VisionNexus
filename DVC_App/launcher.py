...
Workspace final : <workspace>/dvc_alice/
"""
...
def main():
    parser = argparse.ArgumentParser(description="Launch dvc-app")
    ...
    env = {**os.environ,
           "DVC_APP_WORKSPACE": ws, "DVC_APP_USER": args.user, "DVC_APP_FRONTEND_PORT": str(fp),
    ...
    print("=" * 60); print(f"  dvc-app — {args.user}"); print("=" * 60)
