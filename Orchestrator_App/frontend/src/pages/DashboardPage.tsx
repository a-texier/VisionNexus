...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      {/* Active run widget */}
      <div>
        <h2 className="text-xs font-medium text-gray-500 uppercase mb-3">Pipeline actif</h2>
        <ActiveRunWidget />
        {!activity.some(r => r.status === 'running') && (
          <p className="text-sm text-gray-600 py-2">Aucun pipeline en cours d'exécution</p>
        )}
      </div>

      {/* Activity feed */}
      <div>
        <h2 className="text-xs font-medium text-gray-500 uppercase mb-3">Activité récente</h2>
