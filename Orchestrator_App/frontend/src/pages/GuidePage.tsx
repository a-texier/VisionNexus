// ============================================================
// pages/GuidePage.tsx
// Sous-onglet MLOps > Guide : documentation integree. Rend les pages
// markdown de Orchestrator_App/docs/ servies par /api/docs ; le contenu
// n'existe qu'a un seul endroit (les .md), cette page ne fait que
// naviguer et afficher.
//
// Etat dans l'URL pour les liens profonds : /mlops/guide?doc=workflows#h-4
...
export default function GuidePage() {
  ...
  const t = useT()
  const [lang] = useLang()
  // La page vit dans le conteneur de l'onglet MLOps : c'est lui qui defile, pas window.
  ...
  return (
    <div ref={scrollRef} className="h-full overflow-y-auto">
      <div className="flex gap-8 px-6 py-6 max-w-7xl mx-auto">
        <aside className="w-64 flex-shrink-0 self-start sticky top-6 max-h-[calc(100vh-120px)] overflow-y-auto pr-2 text-sm">
