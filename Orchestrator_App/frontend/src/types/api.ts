...
// ── Moteurs d'entrainement (GET /api/engines) ─────────────────────────────────
// Tout ce que les noeuds Model / Training / Optuna affichent d'un moteur vient
// de son catalogue : aucun nom de moteur n'est ecrit en dur dans l'UI.
...
export interface EngineCatalog {
  ...
  groups: { label: string; params: EngineField[] }[]
  keys: Record<string, string>
  hpo_ranges: Record<string, EngineRange>
  hpo_default_optimize: string[]
}
