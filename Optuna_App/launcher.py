...
def main():
    parser = argparse.ArgumentParser(description="Launch optuna-app")
    ...
    env = {**os.environ,
           "OPTUNA_APP_WORKSPACE": ws, "OPTUNA_APP_USER": args.user, "OPTUNA_APP_FRONTEND_PORT": str(fp),
