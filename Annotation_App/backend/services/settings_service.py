...
DEFAULT_SETTINGS: Dict[str, Any] = {
    ...
    "algorithms": {
        ...
        # YOLO custom (tracking guidé) — chemin du modèle .pt, résolu par rapport
        # au workspace s'il est relatif. Vide = option YOLO indisponible dans l'UI.
        "yolo_model_path": "",
        # Seuil de confiance BAS par défaut : en mode tracking, le matching
        # centroïde écarte les fausses alarmes → on maximise le rappel.
