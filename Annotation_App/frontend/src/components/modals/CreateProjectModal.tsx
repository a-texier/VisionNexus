    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-slate-800 border border-slate-700 rounded-xl p-6 w-96 shadow-2xl">
        ...
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-base font-semibold text-slate-100">Nouveau projet</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
          {/* Nom du projet */}
          <div>
            <label className="block text-xs text-slate-400 mb-1.5">Nom du projet</label>
            <input
              autoFocus
              type="text"
              value={name}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { value: 'image', label: 'Image Random', Icon: Image, desc: 'Jeu d\'images non-séquentielles' },
                { value: 'video', label: 'Séquence Image', Icon: Film, desc: 'Vidéo .mp4 ou dossier d\'images' },
