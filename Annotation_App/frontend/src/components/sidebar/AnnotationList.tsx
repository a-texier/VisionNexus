    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between px-2 py-1.5 border-b border-slate-700">
        ...
        <div className="flex gap-1">
          ...
          <button
            ...
            title="Afficher annotations IA uniquement"
          >
            IA
          </button>
          ...
          <button
            ...
            title="Filtrer par score de confiance"
          >
          ...
          <button
            ...
            title="Non-Maximum Suppression — supprimer les doublons"
          >
            <Layers size={12} />
          </button>
      ...
      {showNMS && (
        <div className="px-2 py-2 bg-orange-900/10 border-b border-orange-800/30">
          <p className="text-xs text-orange-300 mb-1.5 font-medium flex items-center gap-1">
            <Zap size={11} /> NMS — Supprimer chevauchements
          </p>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Garde l'annotation avec la meilleure confiance.
          </p>
          <button
          ...
          >
            {isNMSRunning ? 'Traitement...' : 'Appliquer NMS'}
          </button>
        </div>
      )}
      ...
      {showConfidenceSlider && (
        <div className="px-2 py-2 bg-indigo-900/10 border-b border-indigo-800/30">
          <p className="text-xs text-indigo-300 mb-1.5 font-medium flex items-center gap-1">
            <SlidersHorizontal size={11} /> Score min de confiance
          </p>
          <div className="flex items-center gap-2">
            <input
              type="range"
        ...
        {filteredAnnotations.length === 0 ? (
          <p className="text-xs text-slate-500 text-center py-6">
            {annotations.length === 0
              ? 'Aucune annotation sur cette frame.'
          ...
          filteredAnnotations.map((ann, idx) => {
            ...
            return (
              <div
                ...
                title="Clic = sélection | Shift+clic = sélection intervalle | Double-clic = zoom"
              >
                {/* Indicateur couleur */}
                <div
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                    ...
                    {onAssignTrack ? (
                      ...
                      >
                        ...
                        <option value="new" style={{ backgroundColor: '#1e293b', color: '#e2e8f0' }}>+ nouvelle</option>
                        {tracks.map((t) => (
        ...
        <div className="flex-shrink-0 border-t-2 border-teal-700/60 bg-teal-950/20">
          ...
          >
            <span className="text-xs text-teal-400 font-medium flex items-center gap-1">
              <Cpu size={11} />
              SAM Auto — {streamedMasks.length} proposition{streamedMasks.length !== 1 ? 's' : ''}
            </span>
            <div className="flex items-center gap-1">
              <span className="text-xs text-slate-500 italic">non validées</span>
          ...
          {showProposals && (
            <>
              ...
              <div className="flex items-center gap-1 px-2 pb-1">
                ...
                >
                  <CheckCircle size={10} />
                  {isValidatingAll ? 'Validation…' : `Valider tout (${streamedMasks.length})`}
                </button>
                <button
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 text-xs">
                        <span className="text-slate-400">Proposition {idx + 1}</span>
                      ...
                      <button
                        ...
                        title="Valider → ajouter comme annotation"
                      >
                        <CheckCircle size={13} />
                      </button>
                      <button
      ...
      <div className="flex items-center justify-between px-2 py-1.5 border-t border-slate-700 gap-1">
        ...
        <span className="text-xs text-slate-600 flex-1 text-center">
          {selectedAnnotationIds.size > 0 ? `${selectedAnnotationIds.size} sél.` : ''}
        </span>
        ...
        {annotations.length > 0 && (
          confirmDeleteAll ? (
            ...
            <button
              ...
              title="Supprimer toutes les annotations de cette frame"
            >
              <Trash2 size={11} />
              Tout
            </button>
