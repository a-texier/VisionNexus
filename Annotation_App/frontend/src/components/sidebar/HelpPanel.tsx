...
export const HelpPanel: React.FC = () => {
  ...
  const SECTIONS: { id: Section; label: string; Icon: React.FC<{ size: number }> }[] = [
    ...
    { id: 'features', label: 'Modes & Fonctions', Icon: Info },
      ...
      <div className="flex-1 overflow-y-auto p-2">
        ...
        {section === 'features' && (
          <div className="space-y-4">
            <div>
              <p className="text-[10px] uppercase tracking-wide text-slate-500 mb-1.5">Modes d'annotation</p>
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wide text-slate-500 mb-1.5">Modes de suivi (Tracks)</p>
              <div className="space-y-2">
            ...
            <div>
              <p className="text-[10px] uppercase tracking-wide text-slate-500 mb-1.5">Fonctions</p>
              <div className="space-y-2">
