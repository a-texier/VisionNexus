...
export const buildAnnotationTourSteps = (): TourStep[] => {
  ...
  // ============================================================
  {
    id: 'welcome',
    chapter: 'Bienvenue',
    title: 'Le tour complet en une dizaine de minutes',
    body: [
      "Ce tutoriel construit avec vous un vrai projet, de la page d'accueil jusqu'a l'export : "
    ...
    hint: "Echap ferme le tutoriel a tout moment. La page reste utilisable pendant le tour : vous pouvez cliquer et dessiner normalement.",
    placement: 'center',
  ...
  },
  {
    ...
    body: [
      ...
      "Le tutoriel a saisi \"Template Cars Annotation\" pour vous.",
    ],
  ...
  },
  {
    ...
    chapter: '1. Creer le projet',
    title: 'Image Random ou Sequence Image ?',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      "Suivant cree reellement le projet.",
    ],
  ...
  {
    id: 'import-btn',
    chapter: '2. Importer les images',
    title: 'Le projet est vide : importons des frames',
    body: [
      "Un projet peut contenir plusieurs sequences (dossiers d'images et videos melanges). Chaque import en cree une.",
      "Suivant ouvre la fenetre d'import.",
    ],
  ...
  },
  {
    ...
    chapter: '2. Importer les images',
    title: 'Chemin serveur ou glisser-deposer ?',
    body: [
  ...
  },
  {
    id: 'import-submit',
    chapter: '2. Importer les images',
    title: 'Importer en tache de fond',
    body: [
      ...
      "Suivant lance l'import des 10 images.",
    ],
  ...
  {
    id: 'tour-left-panel',
    chapter: "3. Reperage de l'ecran",
    title: 'A gauche : le suivi (tracking)',
    body: [
  ...
  },
  {
    id: 'tour-text-prompt',
    chapter: "3. Reperage de l'ecran",
    title: 'En haut : annoter par texte (Grounding DINO / SAM3)',
    body: [
  ...
  },
  {
    id: 'tour-right-panel',
    chapter: "3. Reperage de l'ecran",
    title: 'A droite : classes, annotations, aide',
    body: [
      ...
      "La largeur du panneau se regle en glissant son bord gauche.",
    ],
  ...
  {
    id: 'tab-classes',
    chapter: '4. Creer une classe',
    title: "Sans classe, pas d'annotation",
    body: [
  ...
  },
  {
    ...
    body: "Suivant ouvre le formulaire de creation.",
  ...
  },
  {
    ...
    chapter: '4. Creer une classe',
    title: 'La couleur de la classe',
    body: "Elle sert partout : contour des boites sur le canvas, pastilles de la timeline, blocs de pistes. Prenez des couleurs franchement differentes si vous avez plusieurs classes.",
  ...
  },
  {
    ...
    chapter: '4. Creer une classe',
    title: 'Creer la classe',
    body: "Suivant valide la creation.",
  ...
  },
  {
    id: 'class-row-first',
    chapter: '4. Creer une classe',
    title: 'Selectionner la classe active',
    body: [
      ...
      "Suivant selectionne la classe pour vous.",
    ],
  ...
  {
    id: 'frame-nav',
    chapter: '5. Annoter la premiere frame',
    title: 'Se placer sur la bonne frame',
    body: [
  ...
  },
  {
    id: 'canvas-nav',
    chapter: '5. Annoter la premiere frame',
    title: 'Se deplacer dans l\'image',
    body: [
    ...
    placement: 'bottom',
    hint: "Essayez la molette sur l'image, puis l'icone d'expansion pour recentrer.",
  },
  {
    id: 'tool-bbox',
    chapter: '5. Annoter la premiere frame',
    title: "L'outil rectangle",
    body: [
      ...
      "Suivant active l'outil Rectangle.",
    ],
  ...
  },
  {
    id: 'draw-bbox',
    chapter: '5. Annoter la premiere frame',
    title: 'A vous : dessinez la premiere boite',
    body: [
    ...
    hint: "Dessinez une boite autour d'une voiture, puis cliquez sur Fait.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="frame-nav"]' }],
    placement: 'left',
    spotlightPadding: 0,
    nextLabel: 'Fait',
    waitingLabel: "En attente de votre premiere boite sur la frame affichee...",
  ...
  {
    id: 'tab-samurai',
    chapter: '6. Propager le suivi',
    title: 'SAMURAI : une boite suffit',
    body: [
  ...
  },
  {
    id: 'samurai-targets',
    chapter: '6. Propager le suivi',
    title: 'Choisir la cible a suivre',
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      `Le tutoriel a mis ${TEMPLATE_END_FRAME} : huit frames sur les dix importees, assez pour voir le suivi travailler sans monopoliser le GPU.`,
    ],
  ...
  },
  {
    ...
    chapter: '6. Propager le suivi',
    title: 'Le nombre de frames pese sur le GPU',
    body: [
  ...
  },
  {
    ...
    waitingLabel: "Revenez sur la frame que vous avez annotee (curseur encadre en bas) et cochez une cible : le bouton reste grise sans cela.",
    onNext: async () => { await runPropagation('samurai') },
  },
  {
    id: 'samurai-review',
    chapter: '6. Propager le suivi',
    title: "Regardez le resultat avant d'aller plus loin",
    body: [
    ...
    hint: "Faites defiler les frames et verifiez le suivi, puis cliquez sur Suivant.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="frame-nav"]' }],
    placement: 'left',
    spotlightPadding: 0,
  ...
  },
  {
    id: 'timeline-cleanup',
    chapter: '6. Propager le suivi',
    title: 'Corriger ce que le modele a rate',
    body: [
    ...
    target: { selector: '[data-tour="timeline"]' },
    placement: 'top',
    hint: "Essayez : Ctrl+clic sur deux cases de la timeline, puis Suppr pour vider ces deux frames.",
  },
  ...
  {
    id: 'multi-intro',
    chapter: '7. Suivre deux objets',
    title: 'Et quand il y a plusieurs objets ?',
    body: [
    ...
    hint: "Dessinez deux nouvelles boites, sur deux vehicules encore libres, puis cliquez sur Fait.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="tool-bbox"]' }],
    placement: 'left',
    spotlightPadding: 0,
    nextLabel: 'Fait',
    waitingLabel: 'En attente de deux NOUVELLES boites sur cette frame...',
  ...
  },
  {
    id: 'multi-pick',
    chapter: '7. Suivre deux objets',
    title: 'Designer les deux cibles : double-clic sur le canvas',
    body: [
    ...
    hint: "Double-cliquez les deux vehicules a suivre, puis cliquez sur Fait.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="samurai-targets"]' }],
    placement: 'left',
    spotlightPadding: 0,
    nextLabel: 'Fait',
    waitingLabel: "Double-cliquez exactement deux boites sur l'image...",
  ...
  },
  {
    id: 'multi-targets',
    chapter: '7. Suivre deux objets',
    title: 'Ce que la liste confirme',
    body: [
  ...
  },
  {
    ...
    chapter: '7. Suivre deux objets',
    title: 'Auto (rapide) : SAM2 multi-objets',
    body: [
      ...
      "Suivant selectionne Auto (rapide).",
    ],
  ...
  },
  {
    id: 'multi-propagate',
    chapter: '7. Suivre deux objets',
    title: 'Propager les deux cibles',
    body: [
    ...
    waitingLabel: "Il faut exactement deux cibles cochees (double-clic sur le canvas), et aucune propagation en cours.",
    onNext: async () => { await runPropagation('multi') },
  },
  {
    id: 'multi-review',
    chapter: '7. Suivre deux objets',
    title: 'Deux contours qui se suivent',
    body: [
    ...
    hint: "Parcourez les frames et comparez les deux pistes, puis cliquez sur Suivant.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="frame-nav"]' }],
    placement: 'left',
    spotlightPadding: 0,
  ...
  {
    id: 'tab-guided',
    chapter: '8. Detecter par texte',
    title: "L'onglet Detect. : la troisieme facon d'annoter",
    body: [
  ...
  },
  {
    ...
    body: [
      ...
      "Le tutoriel a saisi le prompt pour vous.",
    ],
  ...
  },
  {
    id: 'guided-run',
    chapter: '8. Detecter par texte',
    title: 'Detecter puis associer : distance au centroide',
    body: [
      ...
      "Rien n'est lance ici : ce serait une troisieme passe sur la meme sequence.",
    ],
    hint: "Cochez une cible puis cliquez sur ce bouton quand vous voudrez l'essayer.",
  ...
  {
    id: 'lut-btn',
    chapter: '9. Affichage et export',
    title: 'La LUT : images 16 bits et contraste',
    body: "Ce bouton ouvre l'histogramme et le remappage d'affichage. Suivant l'ouvre pour de vrai.",
  ...
  },
  {
    id: 'lut-panel',
    chapter: '9. Affichage et export',
    title: 'Ce que la LUT change vraiment',
    body: [
  ...
  },
  {
    id: 'export-btn',
    chapter: '9. Affichage et export',
    title: 'Exporter le dataset',
    body: "Suivant ouvre la fenetre d'export.",
  ...
  {
    id: 'settings-btn',
    chapter: '10. Pour aller plus loin',
  ...
  },
  {
    id: 'help-btn',
    chapter: '10. Pour aller plus loin',
    title: "L'aide, et comment relancer ce tutoriel",
    body: [
  ...
  {
    id: 'back-home',
    chapter: '11. Un projet Image Random',
    ...
    body: [
      ...
      "On va creer un SECOND projet, de l'autre type, pour voir ce qui change.",
      "Suivant retourne a l'accueil.",
    ],
  ...
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Nouveau projet, deuxieme type',
    body: "Suivant rouvre la fenetre de creation.",
    target: { selector: '[data-tour="new-project-btn"]' },
    placement: 'bottom',
    onNext: async () => { await clickWhenReady('[data-tour="new-project-btn"]') },
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Un nom, et surtout un autre type',
    body: [
      "Le tutoriel a saisi \"Template Traffic Lights\".",
  ...
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Image Random : ce que ca retire',
    body: [
      ...
      "Suivant selectionne ce type, puis cree le projet.",
    ],
  ...
  },
  {
    id: 'second-class',
    chapter: '11. Un projet Image Random',
    title: 'Une classe pour ce projet',
    body: [
  ...
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Classe active : obligatoire pour le texte',
    body: [
      ...
      "C'est l'erreur numero un sur l'annotation par texte.",
    ],
    target: { selector: '[data-tour="class-row-first"]' },
    placement: 'left',
    waitTimeoutMs: 8000,
  },
  {
    id: 'second-text-open',
    chapter: '11. Un projet Image Random',
    title: 'Annoter par texte, pour de vrai',
    body: [
      "Ce bouton ouvre la zone de detection par texte. Suivant l'ouvre.",
    ],
    target: { selector: '[data-tour="text-prompt-btn"]' },
    placement: 'bottom',
    onNext: async () => {
  ...
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Decrire ce qu\'on cherche',
    body: [
  ...
  },
  {
    ...
    chapter: '11. Un projet Image Random',
    title: 'Tout le lot, pas seulement cette image',
    body: [
  ...
  },
  {
    id: 'second-review',
    chapter: '11. Un projet Image Random',
    title: 'Regardez ce que le detecteur a trouve',
    body: [
    ...
    hint: "Faites defiler les images et jugez les detections, puis cliquez sur Suivant.",
    target: { selector: '[data-tour="canvas-area"]' },
    alsoTargets: [{ selector: '[data-tour="frame-nav"]' }],
    placement: 'left',
    spotlightPadding: 0,
  ...
  },
  {
    id: 'second-no-tracks',
    chapter: '11. Un projet Image Random',
    title: 'Aucune piste, et c\'est voulu',
    body: [
  ...
  {
    id: 'home-again',
    chapter: '12. Pour finir',
    title: 'Retour a l\'accueil',
    body: "Suivant revient a la liste des projets : vos deux projets de demonstration y sont, en orange.",
    target: { selector: '[data-tour="back-home"]' },
    placement: 'bottom',
    onNext: async (ctx) => {
      (ctx as AnnotationTourContext).navigate('/')
  ...
  },
  {
    ...
    body: [
      ...
      "Parametres : tous les reglages, memorises dans votre workspace.",
  ...
  // ---- Monitoring : on y entre pour de vrai ----
  {
    id: 'monitoring-enter',
    chapter: '12. Pour finir',
    title: 'Monitoring : mesurer ce que l\'automatique a fait',
    body: [
  ...
  },
  {
    ...
    chapter: '12. Pour finir',
    title: 'Automatique, manuel, retouche',
    body: [
  ...
  },
  {
    id: 'monitoring-scope',
    chapter: '12. Pour finir',
    title: 'Moi, ou tous les utilisateurs',
    body: [
      ...
      "Aucune ecriture n'a lieu ici : la page ne fait que lire les bases des projets.",
    ],
  ...
  },
  {
    id: 'monitoring-view',
    chapter: '12. Pour finir',
    title: 'Detail par sequence, ou vue globale',
    body: [
  ...
  // ---- Presentation : la doc de fond ----
  {
    id: 'presentation-btn',
    chapter: '12. Pour finir',
    title: 'Presentation : le pourquoi',
    body: [
  ...
  },
  {
    ...
    chapter: '12. Pour finir',
    title: 'Six onglets de documentation',
    body: [
      "Generalites : a quoi sert l'application et comment elle est organisee. Utilisation : le workflow detaille, par type de projet. Algorithmes : SAM2, SAMURAI, Grounding DINO, SAM3, XFeat, flux optique -- ce que chacun fait et quand le prendre.",
      "Technique & Methodes : formats, base de donnees, API, structure du workspace. Mode Developpeur : de quoi reprendre le code. Optimisations : ce qui a ete fait pour que ca tienne sur de grosses sequences et a travers un partage reseau.",
      "Tout y est ecrit : quand une question reste apres ce tutoriel, la reponse est dans l'un de ces six onglets.",
    ],
    hint: "Ouvrez un onglet ou deux si vous voulez jeter un oeil, puis cliquez sur Suivant.",
