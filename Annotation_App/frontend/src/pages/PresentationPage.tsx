  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-x-hidden">
          ...
          {MAIN_TABS.map((t) => (
            <button
              ...
              className={`flex items-center gap-1.5 px-4 py-1.5 rounded-lg border text-xs font-semibold transition-colors ${
                mainTab === t.id ? t.active : t.inactive
              }`}
            >
              {t.icon}
              {t.label}
      ...
      {mainTab === 'usage' && (
        <div className="px-6 py-8 max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">Utilisation de l'Application</h2>
          </div>
      ...
      {mainTab === 'technical' && (
        <div className="px-6 py-8 max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold text-white">Technique & Méthodologie</h2>
          </div>
      ...
      <div className="border-t border-slate-800 px-6 py-8 text-center text-xs text-slate-600">
        AnnotationApp — Documentation intégrée — FastAPI · React · Konva.js · SAM2 · SAMURAI · Grounding DINO · XFeat
      </div>
    </div>
  )
}
