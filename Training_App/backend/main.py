...
# FastAPI backend : entrainement YOLO via Ultralytics.
#
# Lancement solo :
...
from backend.routers import training, orchestrator
...
app = FastAPI(
    title="Training App",
    description="""
    Entrainement de modeles YOLO via Ultralytics.

    ## Fonctionnalites
    - **YOLOv8 / v9 / v10 / YOLO11** — tous les modeles Ultralytics
